...
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	TBCalculoLoop["TBCalculoLoop"]

	TBCalculoEntrada["TBCalculoEntrada"]

	TBCalculoFormula["TBCalculoFormula"]

	TBCalculo["TBCalculo"]

	TBCalculoLote["TBCalculoLote"]

	TBLoopColuna["TBLoopColuna"]

	TBMecanismoLoop["TBMecanismoLoop"]

	TBMecanismoEntrada["TBMecanismoEntrada"]

	TBMecanismoFormula["TBMecanismoFormula"]

	TBMecanismo["TBMecanismo"]

	TBTabelaGenericaItem["TBTabelaGenericaItem"]

	TBTabelaGenerica["TBTabelaGenerica"]

	TBTipoDado["TBTipoDado"]

	TBTipoIncremento["TBTipoIncremento"]

	TBCalculo --> TBCalculoEntrada
	TBCalculo --> TBCalculoFormula
	TBCalculo --> TBCalculoLoop
	TBCalculoLote --> TBCalculo
	TBLoopColuna --> TBCalculoLoop
	TBMecanismoLoop --> TBLoopColuna
	TBMecanismoEntrada --> TBCalculoEntrada
	TBMecanismoFormula --> TBCalculoFormula
	TBMecanismo --> TBCalculo
	TBMecanismo --> TBMecanismoEntrada
	TBMecanismo --> TBMecanismoFormula
	TBMecanismo --> TBMecanismoLoop
	TBTabelaGenerica --> TBMecanismoEntrada
	TBTabelaGenerica --> TBTabelaGenericaItem
	TBTipoDado --> TBLoopColuna
	TBTipoDado --> TBMecanismoEntrada
	TBTipoDado --> TBMecanismoFormula
	TBTipoIncremento --> TBMecanismoLoop
```

```mermaid
graph TB
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	GER_INDICE_VALOR["GER_INDICE_VALOR"]

	GER_INDICE_AGRUPADO["GER_INDICE_AGRUPADO"]

	GER_INDICE["GER_INDICE"]

	GER_CARGO_VALOR["GER_CARGO_VALOR"]

	GER_CARGO["GER_CARGO"]

	GER_INDICE --> GER_INDICE_AGRUPADO
	GER_INDICE --> GER_INDICE_VALOR
	GER_CARGO --> GER_CARGO_VALOR
```

```mermaid
graph TB
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	TBSoldoGapNovo["TBSoldoGapNovo"]

	TBPatente["TBPatente"]

	RHU_CONTRACHEQUES["RHU_CONTRACHEQUES"]

	LOG_FTP["LOG_FTP"]

	GER_MOEDA_VALOR["GER_MOEDA_VALOR"]

	GER_MOEDA["GER_MOEDA"]

	TBPatente --> TBSoldoGapNovo
	LOG_FTP --> RHU_CONTRACHEQUES
	GER_MOEDA --> GER_MOEDA_VALOR
```
...
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	...
	GER_REMUNERACAO["GER_REMUNERACAO"]

	GER_TIPO_RETORNO["GER_TIPO_RETORNO"]

	LOG_APLICACAO["LOG_APLICACAO"]

	LOG_INDICE_AGRUPADO["LOG_INDICE_AGRUPADO"]

	RHU_CONTRACHEQUES_BKP["RHU_CONTRACHEQUES_BKP"]
...
graph TB
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	RHU_CONTRACHEQUES_EXPURGO["RHU_CONTRACHEQUES_EXPURGO"]

	RHU_CONTRACHEQUES_VD["RHU_CONTRACHEQUES_VD"]

	RHU_CONTRACHEQUES_VD_BKP["RHU_CONTRACHEQUES_VD_BKP"]

	RHU_CONTRACHEQUES_VD_EXPURGO["RHU_CONTRACHEQUES_VD_EXPURGO"]

	RHU_ORGAO["RHU_ORGAO"]

	RHU_SERVIDOR["RHU_SERVIDOR"]
...
graph TB
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	RHU_SERVIDOR_BKP["RHU_SERVIDOR_BKP"]

	RHU_SERVIDORES["RHU_SERVIDORES"]

	RHU_SERVIDORES2["RHU_SERVIDORES2"]

	Servidor["Servidor"]

	Servidores["Servidores"]

	TB_AUXILIAR_CALCULO_ENTRADA["TB_AUXILIAR_CALCULO_ENTRADA"]
...
graph TB
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	TB_AUXILIAR_DIVERSOS["TB_AUXILIAR_DIVERSOS"]

	TBCalculoCorrecaoMonetaria["TBCalculoCorrecaoMonetaria"]

	TBCalculoExecucaoStatus["TBCalculoExecucaoStatus"]

	TBCalculoProgresso["TBCalculoProgresso"]

	TBHonorariosAdvocaticios["TBHonorariosAdvocaticios"]

	TBHonorariosIndiceCorrecaoMonetaria["TBHonorariosIndiceCorrecaoMonetaria"]
...
graph TB
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	TBIndiceCorrecaoMonetaria["TBIndiceCorrecaoMonetaria"]

	TBIRRF["TBIRRF"]

	TBIRRFFaixas["TBIRRFFaixas"]

	TBJurosFazenda["TBJurosFazenda"]

	TBJurosSelic["TBJurosSelic"]

	TBLabelImpressao["TBLabelImpressao"]
...
graph TB
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	TBLeisMagisterio["TBLeisMagisterio"]

	TBLimiteConstitucional["TBLimiteConstitucional"]

	TBLogRelatorio["TBLogRelatorio"]

	TBMapeamentoVerbas["TBMapeamentoVerbas"]

	TBMecanismoRelatorio["TBMecanismoRelatorio"]

	TBMecanismoRelatorioGenerico["TBMecanismoRelatorioGenerico"]
...
graph TB
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	TBMecanismoRelatorioGenericoIteracoes["TBMecanismoRelatorioGenericoIteracoes"]

	TBMecanismoRelatorioGenericoTipo["TBMecanismoRelatorioGenericoTipo"]

	TBMecanismoRelatorioParametros["TBMecanismoRelatorioParametros"]

	TBMecanismoRelatorioViews["TBMecanismoRelatorioViews"]

	TBMetaTaxaSelic["TBMetaTaxaSelic"]

	TBOficialPM["TBOficialPM"]
...
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	...
	TBParecerCalculo["TBParecerCalculo"]

	TBParecerDados["TBParecerDados"]

	TBParecerOpcao["TBParecerOpcao"]

	TBParecerSecao["TBParecerSecao"]

	TBParecerSecaoVariavel["TBParecerSecaoVariavel"]
...
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	...
	TBResumoRelatorio["TBResumoRelatorio"]

	TBResumoRelatorioValores["TBResumoRelatorioValores"]

	TBSoldoGap["TBSoldoGap"]

	TBSoldoGap2["TBSoldoGap2"]

	TBSoldoGapPMEstendida["TBSoldoGapPMEstendida"]
...
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	...
	TBTabIndiceCorrecaoMonet["TBTabIndiceCorrecaoMonet"]

	TBTabLimiteConstitucional["TBTabLimiteConstitucional"]

	TBTipoIndiceCorrecaoMonet["TBTipoIndiceCorrecaoMonet"]

	TBValorFixoRelatorio["TBValorFixoRelatorio"]

	TBVantagemContraCheque["TBVantagemContraCheque"]
...
graph TB
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	TBVantagemVerba["TBVantagemVerba"]

	TEMP_CC_APAGAR["TEMP_CC_APAGAR"]

	TEMP_CC_DUPLICADOS["TEMP_CC_DUPLICADOS"]

	TEMP_CC_DUPLICADOS_CONFIRMADOS["TEMP_CC_DUPLICADOS_CONFIRMADOS"]

	temp_contracheques_duplicados3["temp_contracheques_duplicados3"]

	temp_contracheques_duplicados4["temp_contracheques_duplicados4"]
...
graph TB
%%{ init: { 'theme': 'neutral', 'flowchart': { 'useMaxWidth': false, 'curve': 'basis' }}}%%
	TEMP_DATA_REFERENCIA["TEMP_DATA_REFERENCIA"]

	TEMP_QTD_CC_DATA_ARQUIVO["TEMP_QTD_CC_DATA_ARQUIVO"]

	TEMP_QTD_CC_DATA_REFERENCIA["TEMP_QTD_CC_DATA_REFERENCIA"]

	TEMP_QTD_MAT_DATA_REFERENCIA["TEMP_QTD_MAT_DATA_REFERENCIA"]
